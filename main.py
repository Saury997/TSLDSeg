    ...
    def log_img(self, pl_module, batch, batch_idx, split="train"):
        ...
        if (self.log_dice_frequency and
            ...
            with torch.no_grad():
                ...
                # print("[metric list]", metrics_dict["test_avg_dice"], metrics_dict["test_avg_iou"])
            ...
            for key, value in metrics_dict.items():
                if key == "test_avg_dice" or key == "test_avg_iou":
                ...
                elif "test_avg_dice" in key or "test_avg_iou" in key:     # isinstance(value, list) and len(value) > 0:
...
if __name__ == "__main__":
    ...
    try:
        ...
        if hasattr(model, "monitor"):
            ...
            elif model.monitor == "test_avg_dice":
