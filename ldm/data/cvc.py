...
class CVCTrain(CVCBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/CVC/images", mode="train", **kwargs)


class CVCValidation(CVCBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/CVC/images", mode="val", **kwargs)


class CVCTest(CVCBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/CVC/images", mode="test", **kwargs)
