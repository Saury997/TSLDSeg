...
class ETISBase(Dataset):
    """ETIS-LaribPolypDB Dataset Base
    Notes:
    ...
    def __init__(self, data_root, size=256, interpolation="nearest", mode=None, num_classes=2):
        ...
        print(f"[Dataset]: ETIS-LaribPolypDB with 2 classes, in {self.mode} mode")
...
class ETISTrain(ETISBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/ETIS-LaribPolypDB/images", mode="train", **kwargs)


class ETISValidation(ETISBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/ETIS-LaribPolypDB/images", mode="val", **kwargs)


class ETISTest(ETISBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/ETIS-LaribPolypDB/images", mode="test", **kwargs)

if __name__ == "__main__":
    dataset = ETISTrain(size=256)
