...
class KSEGTrain(KSEGBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/Kvasir-SEG/images", mode="train", **kwargs)


class KSEGValidation(KSEGBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/Kvasir-SEG/images", mode="val", **kwargs)


class KSEGTest(KSEGBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/Kvasir-SEG/images", mode="test", **kwargs)

if __name__ == "__main__":
    dataset = KSEGTrain(size=256)
