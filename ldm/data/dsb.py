...
class DSBBase(Dataset):
    ...
    def __init__(self, data_root, size=256, interpolation="nearest", mode=None, num_classes=2):
        ...
        print(f"[Dataset]: DSB18 with 2 classes, in {self.mode} mode")
...
class DSBTrain(DSBBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/DSB18/images", mode="train", **kwargs)


class DSBValidation(DSBBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/DSB18/images", mode="val", **kwargs)


class DSBTest(DSBBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/root/datasets/DSB18/images", mode="test", **kwargs)


if __name__ == "__main__":
    dataset = DSBTrain(size=256)
